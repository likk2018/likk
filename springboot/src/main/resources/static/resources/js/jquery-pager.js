...
(function($) {
    ...
    function renderpager(pagenumber, pagecount, buttonClickCallback) {
        ...
        // add in the previous and 下页 buttons
        ...
        // pager currently only handles 10 viewable pages ( could be easily parameterized, maybe in 下页 version ) so handle edge cases
        var startPoint = 1;
        var endPoint = 9;
        ...
        for (var page = startPoint; page <= endPoint; page++) {
            ...
            page == pagenumber ? currentButton.addClass('active') : currentButton.click(function() {console.log(this.firstChild.firstChild.data); buttonClickCallback(this.firstChild.firstChild.data); });
            currentButton.appendTo($pager);
        }

        // render in the 下页 and 末页 buttons before returning the whole rendered control back.
        $pager.append(renderButton('下页', pagenumber, pagecount, buttonClickCallback)).append(renderButton('末页', pagenumber, pagecount, buttonClickCallback));
    ...
    // pager defaults. hardly worth bothering with in this case but used as placeholder for expansion in the 下页 version
    $.fn.pager.defaults = {
        pagenumber: 1,
        pagecount: 1
    };
